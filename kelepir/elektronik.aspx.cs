...
namespace kelepir
{
    public partial class elektronik : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                string strQueryy = "select * from esyakayit where tur like 'E%'";
            ...
            string strQuery = "select * from esyakayit where tur like 'E%'"; ;
